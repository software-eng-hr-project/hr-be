...
{
    public abstract class ProjectHrWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ProjectHrWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ProjectHrWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ProjectHrDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ProjectHrDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ProjectHrDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ProjectHrDbContext, Task<T>> func)
        {
            T result;
