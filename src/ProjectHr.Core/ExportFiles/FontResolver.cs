...
{
    private const string FontPath = "Kayak.Common.Resources.Fonts.";
    
    public static byte[] Arial
    {
        get { return LoadFontData($"{FontPath}arial.ttf"); }
    }

    public static byte[] ArialBold
    {
        get { return LoadFontData($"{FontPath}arial.arialbd.ttf"); }
    }

    public static byte[] ArialItalic
    {
        get { return LoadFontData($"{FontPath}arial.ariali.ttf"); }
    }

    public static byte[] ArialBoldItalic
    {
        get { return LoadFontData($"{FontPath}arial.arialbi.ttf"); }
    }
