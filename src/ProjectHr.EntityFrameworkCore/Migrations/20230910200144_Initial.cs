        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxAllowedDaysCount = table.Column<int>(type: "integer", nullable: false),
                    IsPaid = table.Column<bool>(type: "boolean", nullable: false),
                    SpecificGender = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DayOffType", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeLayoff", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                name: "EmployeeLayoffInfos",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    DismissalDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    EmployeeLayoffId = table.Column<int>(type: "integer", nullable: false),
                    LayoffReason = table.Column<string>(type: "text", nullable: true),
                    CreationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    LastModifierUserId = table.Column<long>(type: "bigint", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeLayoffInfos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EmployeeLayoffInfos_EmployeeLayoff_EmployeeLayoffId",
                        column: x => x.EmployeeLayoffId,
                        principalTable: "EmployeeLayoff",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmployeeLayoffInfoId = table.Column<int>(type: "integer", nullable: true),
                    ...
                    JobStartDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    ...
                    MarriedStatus = table.Column<int>(type: "integer", nullable: false),
                    IsSpouseWorking = table.Column<bool>(type: "boolean", nullable: false),
                    ChildrenCount = table.Column<int>(type: "integer", nullable: false),
                    DisabilityLevel = table.Column<int>(type: "integer", nullable: false),
                    IsGraduated = table.Column<bool>(type: "boolean", nullable: false),
                    HigherEducationStatus = table.Column<int>(type: "integer", nullable: false),
                    Country = table.Column<string>(type: "text", nullable: true),
                    City = table.Column<string>(type: "text", nullable: true),
                    AddressDirection = table.Column<string>(type: "text", nullable: true),
                    EmergencyContactName = table.Column<string>(type: "text", nullable: true),
                    EmergencyContactDegree = table.Column<string>(type: "text", nullable: true),
                    EmergencyContactPhone = table.Column<string>(type: "text", nullable: true),
                    IsInvited = table.Column<bool>(type: "boolean", nullable: false),
                    IsThemeLight = table.Column<bool>(type: "boolean", nullable: false),
                    CreationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    LastModifierUserId = table.Column<long>(type: "bigint", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AbpUsers_EmployeeLayoffInfos_EmployeeLayoffInfoId",
                        column: x => x.EmployeeLayoffInfoId,
                        principalTable: "EmployeeLayoffInfos",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DayOffTypeId = table.Column<int>(type: "integer", nullable: false),
                    StartDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    EndDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DayOffRequests_AbpUsers_UserId1",
                        column: x => x.UserId1,
                        principalTable: "AbpUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_DayOffRequests_DayOffType_DayOffTypeId",
                        column: x => x.DayOffTypeId,
                        principalTable: "DayOffType",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DayOffRequests_User_UserId",
                        column: x => x.UserId,
                        principalTable: "User",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsContributing = table.Column<bool>(type: "boolean", nullable: false),
                    CreationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    LastModifierUserId = table.Column<long>(type: "bigint", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProjectMembers_AbpUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProjectMembers_JobTitles_JobTitleId",
                        column: x => x.JobTitleId,
                        principalTable: "JobTitles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TechStackUser", x => new { x.TechStackId, x.UsersId });
                    table.ForeignKey(
                        name: "FK_TechStackUser_AbpUsers_UsersId",
                        column: x => x.UsersId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TechStackUser_TechStacks_TechStackId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AbpUsers_EmergencyContactPhone",
                table: "AbpUsers",
                column: "EmergencyContactPhone",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AbpUsers_EmployeeLayoffInfoId",
                table: "AbpUsers",
                column: "EmployeeLayoffInfoId");

            migrationBuilder.CreateIndex(
                name: "IX_AbpUsers_IdentityNumber",
                table: "AbpUsers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AbpUsers_PersonalPhone",
                table: "AbpUsers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AbpUsers_WorkEmailAddress",
                table: "AbpUsers",
                column: "WorkEmailAddress",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AbpUsers_WorkPhone",
                table: "AbpUsers",
                column: "WorkPhone",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DayOffRequests_UserId1",
                table: "DayOffRequests",
                column: "UserId1");

            migrationBuilder.CreateIndex(
                name: "IX_EmployeeLayoffInfos_EmployeeLayoffId",
                table: "EmployeeLayoffInfos",
                column: "EmployeeLayoffId");

            migrationBuilder.CreateIndex(
                name: "IX_ProjectMembers_JobTitleId",
